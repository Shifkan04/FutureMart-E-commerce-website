...
<head>
    ...
    <title>My Wishlist - FutureMart</title>
    <link href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.3.0/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&display=swap" rel="stylesheet">
    <link href="assets/css/dashboard-style.css" rel="stylesheet">
    <link href="assets/css/wishlist-style.css" rel="stylesheet">
</head>
<body>
    <!-- Navigation -->
     <?php if ($isLoggedIn): ?>
...
<nav class="navbar navbar-expand-lg fixed-top">
            ...
            <div class="col-lg-2 sidebar-wrapper">
                <div class="sidebar">
                    <ul class="sidebar-menu">
                        ...
                        <li class="active"><a href="wishlist.php"><i class="fas fa-heart"></i><span>Wishlist</span><?php if ($dashboardStats['wishlist_count'] > 0): ?><span class="badge"><?= $dashboardStats['wishlist_count'] ?></span><?php endif; ?></a></li>
                ...
                <div class="wishlist-header">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            ...
                            <p class="page-subtitle" id="wishlistCount">Loading...</p>
                        </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <div class="search-box">
                                ...
                                <input type="text" class="form-control" id="searchInput" placeholder="Search wishlist...">
                            </div>
                        </div>
    ...
    <script>
        ...
        document.querySelector('.wishlist-header button').addEventListener('click', function() {
            if (navigator.share) {
                navigator.share({
                    title: 'My FutureMart Wishlist',
                    text: 'Check out my wishlist on FutureMart!',
