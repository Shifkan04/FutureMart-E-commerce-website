<?php
// dashboard.php - Admin Dashboard with Fitness App Design
...
<body>
                            ...
                            <tbody>
                                ...
                                <?php else: ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="orders.php?view=<?php echo $order['id']; ?>" class="btn">
  ...
  <div class="dropdown-icon">
    ...
    <?php if ($totalNotifications > 0): ?>
      <span class="notif-badge"><?php echo $totalNotifications; ?></span>
    <?php endif; ?>

    <!-- Notification Dropdown -->
    <div class="custom-dropdown" id="notifDropdown">
      <?php if ($pendingOrders > 0): ?>
        <a href="orders.php"><i class="fas fa-shopping-cart text-warning"></i> <?php echo $pendingOrders; ?> new order(s)</a>
      <?php endif; ?>

      <?php if ($pendingVendors > 0): ?>
        <a href="vendors.php"><i class="fas fa-user-clock text-info"></i> <?php echo $pendingVendors; ?> vendor approval(s)</a>
      <?php endif; ?>

      <?php if ($lowStockProducts > 0): ?>
        <a href="products.php"><i class="fas fa-exclamation-triangle text-danger"></i> <?php echo $lowStockProducts; ?> low stock alert(s)</a>
      <?php endif; ?>
  ...
  <!-- 💬 Messages Icon -->
  <div class="dropdown-icon">
    <i class="fa fa-envelope" id="msgIcon"></i>
    <?php if ($unreadMessages > 0): ?>
      <span class="notif-badge"><?php echo $unreadMessages; ?></span>
    <?php endif; ?>

    <!-- Messages Dropdown -->
    <div class="custom-dropdown" id="msgDropdown">
      <?php if (!empty($recentMessages)): ?>
        <?php foreach ($recentMessages as $msg): ?>
          <a href="messages.php?chat=<?php echo $msg['id']; ?>">
            <strong><?php echo htmlspecialchars($msg['sender_name']); ?></strong><br>
            <small><?php echo htmlspecialchars(substr($msg['message'], 0, 40)); ?>...</small>
          </a>
        <?php endforeach; ?>
      <?php else: ?>
        <p class="empty-msg">No new messages</p>
      <?php endif; ?>
    </div>
  </div>
                ...
                <div class="quick-stats">
                    ...
                    <div class="stats-list">
                        ...
                        <div class="stat-item">
                            ...
                            <span><?php echo $lowStockProducts; ?></span>
                        </div>
                        <div class="stat-item">
                            <p>Vendor Approvals</p>
                            <span><?php echo $pendingVendors; ?></span>
                        </div>
                        <div class="stat-item">
                            <p>Total Revenue</p>
                            <span><?php echo formatMoney($totalRevenue); ?></span>
                        </div>
                    </div>
                </div>
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
  ...
  bellIcon.addEventListener("click", (e) => {
    ...
    msgDropdown.style.display = "none"; // hide messages if open
  });
  ...
  msgIcon.addEventListener("click", (e) => {
    ...
    notifDropdown.style.display = "none"; // hide notifications if open
  });
